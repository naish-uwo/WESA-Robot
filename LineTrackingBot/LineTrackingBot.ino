/*
 ...
 Line Tracking Robot (MSEBot)
 Language: Arduino
 Authors: Michael Naish and Eugen Porter
 Date: 2023/08/11

 Rev 1 - Initial version from MSEBot-base
...
unsigned int ui_Motor_Speed = 1625;        // Default run speed
...
boolean bt_Left = false;
boolean bt_Middle = false;
boolean bt_Right = false;

unsigned long ul_Echo_Time;
unsigned long ul_Ping_Time;
...
unsigned int  uiArray[16] = {
  1,2,4,8,16,32,64,128,256,512,1024,2048,4096,8192,16384,32768};
unsigned int  uiArrayIndex = 0;
        ...
        else if((millis() - ul_Calibration_Time) > ci_Motor_Calibration_Time) 
        {
          ...
          if(ul_Left_Motor_Position > ul_Right_Motor_Position)
          {
           // May have to update this if different calibration time is used
            ...
            ui_Left_Motor_Offset = (ul_Left_Motor_Position - ul_Right_Motor_Position)/3.43;  
          }
          else
          {
           // May have to update this if different calibration time is used
            ui_Right_Motor_Offset = (ul_Right_Motor_Position - ul_Left_Motor_Position)/3.43;
...
void Indicator()
{
  ...
  CharliePlexM::Write(ci_Indicator_LED,!(ui_Mode_Indicator[ui_Mode_Indicator_Index] & 
                      (uiArray[uiArrayIndex])));
  uiArrayIndex++;
  uiArrayIndex = uiArrayIndex & 15;
}
...
void readLineTrackers()
{
  ...
  bt_Left = (ui_Left_Line_Tracker_Data < (ui_Left_Line_Tracker_Dark - ui_Line_Tracker_Tolerance));
  bt_Middle = (ui_Middle_Line_Tracker_Data < (ui_Middle_Line_Tracker_Dark - ui_Line_Tracker_Tolerance));
  bt_Right = (ui_Right_Line_Tracker_Data < (ui_Right_Line_Tracker_Dark - ui_Line_Tracker_Tolerance));
